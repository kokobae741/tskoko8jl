...
print "\033[93m"
mengetik('==========================================   SELAMAT TEKA MANING YA WA   ')
mengetik('------------------------------------------')
mengetik('Recode: AJA KLALEN MACA DONGA')
mengetik('--------------------')
mengetik('         SUKUR ALHAMDULILLAH LANCAR WA')
mengetik('----------------------------------------')
mengetik('                 ADUS DURUNG WA?')
mengetik('               ---------------')
mengetik('    AJA NDRENGES BAE GAH WA?     ')
print "\033[m"
class Server:
    def __init__(self):
        self.long = 8
    ...
    def show(self):
        ...
        print "\033[m"
        time.sleep(2)
        sys.stderr.write(self.log('========AJA KESUWEN LANJUT BangKoko======== \nReading Server:'))
